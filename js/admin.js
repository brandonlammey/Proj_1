...
$(document).ready(function()
{
    $("#12_time_select").click(
        function()
        {
            ...
            $("#event_time").html
            (
                "<button type='button' id='12:00am'>12:00am</button>"+"<button type='button' id='12:30am'>12:30am</button>"+"<button type='button' id='1:00am'>1:00am</button>"+"<button type='button' id='1:30am'>1:30am</button>"+
                "<button type='button' id='2:00am'>2:00am</button>"+"<button type='button' id='2:30am'>2:30am</button>"+"<button type='button' id='3:00am'>3:00am</button>"+"<button type='button' id='3:30am'>3:30am</button>"+
                "<button type='button' id='4:00am'>4:00am</button>"+"<button type='button' id='4:30am'>4:30am</button>"+"<button type='button' id='5:00am'>5:00am</button>"+"<button type='button' id='5:30am'>5:30am</button>"+
                "<button type='button' id='6:00am'>6:00am</button>"+"<button type='button' id='6:30am'>6:30am</button>"+"<button type='button' id='7:00am'>7:00am</button>"+"<button type='button' id='7:30am'>7:30am</button>"+
                "<button type='button' id='8:00am'>8:00am</button>"+"<button type='button' id='8:30am'>8:30am</button>"+"<button type='button' id='9:00am'>9:00am</button>"+"<button type='button' id='9:30am'>9:30am</button>"+
                "<button type='button' id='10:00am'>10:00am</button>"+"<button type='button' id='10:30am'>10:30am</button>"+"<button type='button' id='11:00am'>11:00am</button>"+"<button type='button' id='11:30am'>11:30am</button>"+
                "<button type='button' id='12:00pm'>12:00pm</button>"+"<button type='button' id='12:30pm'>12:30pm</button>"+"<button type='button' id='1:00pm'>1:00pm</button>"+"<button type='button' id='1:30pm'>1:30pm</button>"+
                "<button type='button' id='2:00pm'>2:00pm</button>"+"<button type='button' id='2:30pm'>2:30pm</button>"+"<button type='button' id='3:00pm'>3:00pm</button>"+"<button type='button' id='3:30pm'>3:30pm</button>"+
                "<button type='button' id='4:00pm'>4:00pm</button>"+"<button type='button' id='4:30pm'>4:30pm</button>"+"<button type='button' id='5:00pm'>5:00pm</button>"+"<button type='button' id='5:30pm'>5:30pm</button>"+
                "<button type='button' id='6:00pm'>6:00pm</button>"+"<button type='button' id='6:30pm'>6:30pm</button>"+"<button type='button' id='7:00pm'>7:00pm</button>"+"<button type='button' id='7:30pm'>7:30pm</button>"+
                "<button type='button' id='8:00pm'>8:00pm</button>"+"<button type='button' id='8:30pm'>8:30pm</button>"+"<button type='button' id='9:00pm'>9:00pm</button>"+"<button type='button' id='9:30pm'>9:30pm</button>"+
                "<button type='button' id='10:00pm'>10:00pm</button>"+"<button type='button' id='10:30pm'>10:30pm</button>"+"<button type='button' id='11:00pm'>11:00pm</button>"+"<button type='button'    id='11:30pm'>11:30pm</button>"
    ...
    $("#24_time_select").click(
        function()
        {
            ...
            $("#event_time").html
            (
                "<button type='button' id='00:00'>00:00</button>"+"<button type='button' id='00:30'>00:30</button>"+"<button type='button' id='1:00'>1:00</button>"+"<button type='button' id='1:30'>1:30</button>"+
                "<button type='button' id='2:00'>2:00</button>"+"<button type='button' id='2:30'>2:30</button>"+"<button type='button' id='3:00'>3:00</button>"+"<button type='button' id='3:30'>3:30</button>"+
                "<button type='button' id='4:00'>4:00</button>"+"<button type='button' id='4:30'>4:30</button>"+"<button type='button' id='5:00'>5:00</button>"+"<button type='button' id='5:30'>5:30</button>"+
                "<button type='button' id='6:00'>6:00</button>"+"<button type='button' id='6:30'>6:30</button>"+"<button type='button' id='7:00'>7:00</button>"+"<button type='button' id='7:30'>7:30</button>"+
                "<button type='button' id='8:00'>8:00</button>"+"<button type='button' id='8:30'>8:30</button>"+"<button type='button' id='9:00'>9:00</button>"+"<button type='button' id='9:30'>9:30</button>"+
                "<button type='button' id='10:00'>10:00</button>"+"<button type='button' id='10:30'>10:30</button>"+"<button type='button' id='11:00'>11:00</button>"+"<button type='button' id='11:30'>11:30</button>"+
                "<button type='button' id='12:00'>12:00</button>"+"<button type='button' id='12:30'>12:30</button>"+"<button type='button' id='13:00'>13:00</button>"+"<button type='button' id='13:30'>13:30</button>"+
                "<button type='button' id='14:00'>14:00</button>"+"<button type='button' id='14:30'>14:30</button>"+"<button type='button' id='15:00'>15:00</button>"+"<button type='button' id='15:30'>15:30</button>"+
                "<button type='button' id='16:00'>16:00</button>"+"<button type='button' id='16:30'>16:30</button>"+"<button type='button' id='17:00'>17:00</button>"+"<button type='button' id='17:30'>17:30</button>"+
                "<button type='button' id='18:00'>18:00</button>"+"<button type='button' id='18:30'>18:30</button>"+"<button type='button' id='19:00'>19:00</button>"+"<button type='button' id='19:30'>19:30</button>"+
                "<button type='button' id='20:00'>20:00</button>"+"<button type='button' id='20:30'>20:30</button>"+"<button type='button' id='21:00'>21:00</button>"+"<button type='button' id='21:30'>21:30</button>"+
                "<button type='button' id='22:00'>22:00</button>"+"<button type='button' id='22:30'>22:30</button>"+"<button type='button' id='23:00'>23:00</button>"+"<button type='button' id='23:30'>23:30</button>"
            );
            $("#event_time").show();
